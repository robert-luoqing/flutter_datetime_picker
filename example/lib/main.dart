...
class CustomPicker extends fdp.CommonPickerModel {
  String digits(int value, int length) {
    return '$value'.padLeft(length, "0");
  }

  CustomPicker({DateTime? currentTime, fdp.LocaleType? locale})
      : super(locale: locale) {
      ...
      body: Center(
        child: Column(
          children: <Widget>[
            TextButton(
                onPressed: () {
                  fdp.DatePicker.showDatePicker(context,
                    ...
                    print('confirm $date');
                  }, currentTime: DateTime.now(), locale: fdp.LocaleType.en);
                },
                child: Text(
            ...
            TextButton(
                onPressed: () {
                  fdp.DatePicker.showTime12hPicker(context,
            ...
            TextButton(
                onPressed: () {
                  fdp.DatePicker.showDateTimePicker(context,
                      showTitleActions: true,
            ...
            TextButton(
                onPressed: () {
                  fdp.DatePicker.showPicker(context, showTitleActions: true,
                      onChanged: (date) {
                    print('change $date in time zone ' +
                        date.timeZoneOffset.inHours.toString());
                  }, onConfirm: (date) {
